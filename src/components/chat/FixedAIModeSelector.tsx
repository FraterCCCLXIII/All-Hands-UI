...
const FixedAIModeSelector: React.FC<AIModeSelectorProps> = ({ 
  selectedMode, 
  onModeChange 
}) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-64 bg-background-card rounded-md shadow-lg border border-border-primary overflow-hidden z-50">
          <ul
...
export default FixedAIModeSelector;